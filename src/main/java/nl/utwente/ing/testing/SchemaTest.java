...
public class SchemaTest {
    ...
    public static Long Category_2_ID;
    public static Long CategoryRule_1_ID;
    ...
    public static void setup() {
        ...
        Category_2_ID = postCategory(sessionID, category_2);
        assignCategoryToTransaction(sessionID, transaction_1_ID, category_1_ID);
        assignCategoryToTransaction(sessionID, transaction_2_ID, Category_2_ID);

        CategoryRule categoryRule_1 = new CategoryRule("test", "NL01RABO0300065264",
                "deposit", Category_2_ID, false);
        CategoryRule_1_ID = postCategoryRule(sessionID, categoryRule_1);
    ...
    public void test_GET_transactions_JSON_schema() {
        ...
        when().
                get(URI_PREFIX + "/transactions?session_id=" + sessionID).
                then().
    ...
    public void test_GET_transaction_ID_JSON_schema() {
        ...
        when().
                get(URI_PREFIX + "/transactions/" + transaction_1_ID.toString() + "?session_id=" + sessionID).
                then().
    ...
    public void test_GET_categories_JSON_schema() {
        ...
        when().
                get(URI_PREFIX + "/categories?session_id=" + sessionID).
                then().
    ...
    public void test_GET_category_ID_JSON_schema() {
        ...
        when().
                get(URI_PREFIX + "/categories/" + category_1_ID.toString() + "?session_id=" + sessionID).
                then().
    ...
    public void test_GET_categoryRule_ID_JSON_schema() {
        when().
                get(URI_PREFIX + "/categoryRules/" + CategoryRule_1_ID.toString() + "?session_id=" + sessionID).
                then().
